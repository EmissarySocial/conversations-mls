		...
		switch (vnode.attrs.message) {
			...
			case "SESSION-EXPIRED":
				return <div>
					...
					To return to conversations, you must <span class="link nowrap" role="link" tabIndex="0" onclick={() => location.reload()} onkeypress={synthClick}>reload this page</span>.
				</div>
			...
			case "SERVER-DOWN":
				return <div>
					...
					To continue with conversations, you must <span class="link nowrap" role="link" tabIndex="0" onclick={() => location.reload()} onkeypress={synthClick}>reload this page</span>.
				</div>

			case "SIGN-OUT":
				return <div>
					<h2><i class="bi bi-slash-circle"></i> Conversations Closed</h2>
					<span class="link nowrap" role="link" tabIndex="0" onclick={() => location.reload()} onkeypress={synthClick}>Reload this page</span> to return to conversations.
				</div>
