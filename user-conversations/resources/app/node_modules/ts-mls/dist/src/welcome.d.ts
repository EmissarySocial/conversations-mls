...
export declare const encryptedGroupSecretsEncoder: Encoder<EncryptedGroupSecrets>;
export declare const encryptedGroupSecretsDecoder: Decoder<EncryptedGroupSecrets>;
/** @public */
...
export declare const welcomeEncoder: Encoder<Welcome>;
export declare const welcomeDecoder: Decoder<Welcome>;
